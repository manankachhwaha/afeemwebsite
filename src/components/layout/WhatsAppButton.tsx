...
export default function WhatsAppButton({ message = defaultWhatsappMessage }: { message?: string }) {
  return (
    <a
      ...
      className="fixed bottom-24 right-5 md:bottom-6 md:right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-105"
    >
